...
<div class="js-dpd-parcelshop-popup dpd-parcelshop-popup">
	...
	<div class="js-dpd-parcelshop-popup-container dpd-parcelshop-popup__container">
		<div class="dpd-parcelshop-popup__content">
			<form class="js-dpd-parcelshop-popup-form dpd-parcelshop-popup__form" data-nonce="<?php echo wp_create_nonce('ar-design-dpd-parcelshop'); ?>">
				<div class="dpd-parcelshop-popup__row">
					<div class="js-dpd-parcelshop-popup-input-wrap dpd-parcelshop-popup__input-wrap">
						<label class="dpd-parcelshop-popup__label" for="dpd-parcelshop-popup-city"><?php echo __('City', 'ar-design-dpd'); ?>*:</label>
					...
					<div class="js-dpd-parcelshop-popup-input-wrap dpd-parcelshop-popup__input-wrap">
						<label class="dpd-parcelshop-popup__label" for="dpd-parcelshop-popup-zip"><?php echo __('Zip', 'ar-design-dpd'); ?>*:</label>
					...
					<div class="js-dpd-parcelshop-popup-input-wrap dpd-parcelshop-popup__input-wrap">
						<label class="dpd-parcelshop-popup__label" for="dpd-parcelshop-popup-country"><?php echo __('Country', 'ar-design-dpd'); ?>*:</label>
				...
				<div class="dpd-parcelshop-popup__row">
					<button type="submit" class="js-dpd-parcelshop-popup-search-btn dpd-parcelshop-popup__search-btn"><?php echo __('Search', 'ar-design-dpd'); ?></button>
				</div>
				...
				<div class="js-dpd-parcelshop-popup-results dpd-parcelshop-popup__results">
					...
					<div class="dpd-parcelshop-popup__row">
						<button type="button" class="js-dpd-parcelshop-popup-choose-parcelshop-btn dpd-parcelshop-popup__choose-btn"><?php echo __('Choose parcelshop', 'ar-design-dpd'); ?></button>
					</div>
				</div>
