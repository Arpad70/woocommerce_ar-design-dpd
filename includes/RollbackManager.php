...
final class ArDesignDpdRollbackManager
{
    private const BACKUP_DIR = 'ard-dpd-backups';
    ...
    public function rollbackOnInstallFailure($result, $hookExtra)
    {
        ...
        return new \WP_Error(
            'ard_dpd_rollback_performed',
            __('Aktualizácia AR Design DPD zlyhala. Predchádzajúca verzia bola automaticky obnovená zo zálohy.', 'ar-design-dpd')
        );
    }
