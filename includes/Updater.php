...
final class ArDesignDpdUpdater
{
    ...
    {
        if ('plugin_information' !== $action || ! is_object($args) || ! isset($args->slug) || 'ar-design-dpd' !== $args->slug) {
            return $result;
        }
        ...
        return (object) array(
            'name' => 'AR Design DPD for WooCommerce',
            'slug' => 'ar-design-dpd',
            'version' => $version,
        ...
        $response = wp_remote_get(
            ...
            array(
                ...
                'headers' => array(
                    ...
                    'User-Agent' => 'ar-design-dpd/' . $this->currentVersion,
                ),
            )
        );
    ...
    {
        return 'ar_design_dpd_release_data_' . md5($this->repositoryFullName);
    }
}
