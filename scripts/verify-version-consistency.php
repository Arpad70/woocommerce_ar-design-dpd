...
$pluginFile = $pluginRoot . '/ar-design-dpd.php';
...
if (! preg_match("/define\\(\\s*'AR_DESIGN_DPD_VERSION'\\s*,\\s*'" . preg_quote($version, '/') . "'\\s*\\)/", $pluginSource)) {
    $errors[] = 'AR_DESIGN_DPD_VERSION does not match VERSION file.';
}
